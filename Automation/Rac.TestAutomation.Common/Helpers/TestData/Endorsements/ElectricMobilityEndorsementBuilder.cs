...
{
    public class ElectricMobilityEndorsementBuilder : EntityBuilder<EndorseElectricMobility, ElectricMobilityEndorsementBuilder>
    {
        /// <summary>
        /// Sets up core fields of the Endorsement data object based on the
        /// provided pet policy number. Will default active policyholder
        /// to be the main policyholder, and payment method to be that
        /// member with the current payment method and frequency.
        /// </summary>
        private ElectricMobilityEndorsementBuilder WithPolicy(string policyNumber, Contact policyHolder)
        {
        ...
        /// </summary>
        public ElectricMobilityEndorsementBuilder WithActivePolicyHolder(Contact policyHolder)
        {
            Set(x => x.ActivePolicyHolder, policyHolder);
            return this;
        }

        public ElectricMobilityEndorsementBuilder WithPaymentMethod(Payment paymentMethod)
        {
        ...
        /// <summary>
        /// sets the payer to a specific contact. Electric Mobility Builder initialisation
        ...
        /// </summary>
        public ElectricMobilityEndorsementBuilder WithPayer(Contact payer)
        {
        ...
        public ElectricMobilityEndorsementBuilder WithRandomPaymentMethod(Contact payer)
        {
        ...
        public ElectricMobilityEndorsementBuilder InitialisePetWithDefaultData(string policynumber, Contact policyHolder = null)
        {
        ...
        public ElectricMobilityEndorsementBuilder WithSparkPaymentChoice(PaymentV2 payment)
        {
            Set(x => x.SparkExpandedPayment, payment);
            return this;
        }

        protected override EndorseElectricMobility BuildEntity()
        {
            return new EndorseElectricMobility
            {
