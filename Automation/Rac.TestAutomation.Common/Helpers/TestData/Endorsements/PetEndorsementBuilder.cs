...
{
    public class PetEndorsementBuilder : EntityBuilder<EndorsePet, PetEndorsementBuilder>
    {
        /// <summary>
        ...
        /// </summary>
        private PetEndorsementBuilder WithPolicy(string policyNumber, Contact policyHolder)
        {
        ...
        /// </summary>
        public PetEndorsementBuilder WithActivePolicyHolder(Contact policyHolder)
        {
            Set(x => x.ActivePolicyHolder, policyHolder);
            return this;
        }

        public PetEndorsementBuilder WithPaymentMethod(Payment paymentMethod)
        {
        ...
        /// <summary>
        /// sets the payer to a specific contact. petBuilder initialisation
        ...
        /// </summary>
        public PetEndorsementBuilder WithPayer(Contact payer)
        {
        ...
        public PetEndorsementBuilder WithRandomPaymentMethod(Contact payer)
        {
        ...
        public PetEndorsementBuilder WithNextPaymentDate(int days)
        {
        ...
        public PetEndorsementBuilder InitialisePetWithDefaultData(string policynumber, Contact policyHolder = null)
        {
        ...
        /// </summary>
        /// TODO AUNT-166
        public PetEndorsementBuilder WithSparkPaymentChoice(PaymentV2 payment)
        {
            Set(x => x.SparkExpandedPayment, payment);
            return this;
        }

        protected override EndorsePet BuildEntity()
        {
            return new EndorsePet
            {
