/*
PURPOSE: Find Caravan policies for duplicate alert testing.
Returns policy number, contact details, and caravan registration.
AUTHOR: Eric Li
...
FROM p_policy p
    JOIN p_pol_header ph ON ph.active_policy_id = p.id
        ...
        AND ph.product_id = 1000008 -- Caravan
