SELECT 
		...
		,p.external_proposal_number AS QuoteNumber
...
AND     ph.status_id = 10 --Quote Status
AND     pc.cover_status_id = 10 --Quote Status
AND     pc.parent_cover_id IS NULL --Only Want the parent cover and not the child covers
and		p.external_proposal_number = @quotenumber
;